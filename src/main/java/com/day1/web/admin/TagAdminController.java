package com.day1.web.admin;


import com.day1.po.Tag;
import com.day1.service.TagService;
...
public class TagAdminController {
    ...
    @PostMapping("/tags")
    public String post(@Valid Tag tag, BindingResult result, RedirectAttributes attribute){
        ...
        if (t == null) {
            //保存失败
            attribute.addFlashAttribute("message","新增失败");
        } else {
            attribute.addFlashAttribute("message","新增成功");
        }
